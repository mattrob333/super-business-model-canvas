...
const AGENT_PROSE_CLASS = [
  ...
  // Headings — Grok-style: section headers that clearly break the page,
  // not bold body lines (owner directive 2026-07-07).
  "[&_h1]:mb-2.5 [&_h1]:mt-6 [&_h1]:text-lg [&_h1]:font-bold [&_h1]:leading-snug [&_h1]:tracking-tight [&_h1]:text-foreground",
  "[&_h2]:mb-2.5 [&_h2]:mt-6 [&_h2]:text-base [&_h2]:font-bold [&_h2]:leading-snug [&_h2]:tracking-tight [&_h2]:text-foreground",
  "[&_h3]:mb-1.5 [&_h3]:mt-4.5 [&_h3]:text-[15px] [&_h3]:font-semibold [&_h3]:text-foreground",
  ...
  // Lists — real markers with the brand accent carrying the eye down the
  // page (Grok-style colored bullets), breathing room, quiet nested lists
  "[&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-5",
  "[&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-5",
  "[&_li]:my-1.5 [&_li]:pl-1 [&_li]:leading-relaxed",
  "[&_ul>li::marker]:text-primary [&_ol>li::marker]:font-semibold [&_ol>li::marker]:text-primary",
  "[&_li_ol]:my-1.5 [&_li_ul]:my-1.5 [&_ul_ul]:list-[circle] [&_ul_ul>li::marker]:text-muted-foreground",
  ...
  "[&_code]:break-words",
  "[&_:not(pre)>code]:rounded [&_:not(pre)>code]:bg-primary/10 [&_:not(pre)>code]:px-1.5 [&_:not(pre)>code]:py-0.5 [&_:not(pre)>code]:text-[0.8125rem] [&_:not(pre)>code]:font-medium [&_:not(pre)>code]:text-primary",
