...
-- ENUMS
-- =============================================================================
do $$ begin create type public.workspace_message_kind as enum ('text', 'tool_call', 'artifact', 'proposal', 'delegation', 'a2ui'); exception when duplicate_object then null; end $$;
-- Existing databases gain 'a2ui' additively (migration 20260713210000).
...
-- =============================================================================
-- ATLAS AT-2: WORKFLOW RUNS + ARTIFACTS
-- =============================================================================
