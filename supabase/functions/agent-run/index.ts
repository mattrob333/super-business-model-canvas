...
serve(async (req) => {
  ...
  try {
    ...
    if (body.mode === 'enqueue') {
      ...
      const workerJobKinds = ['workspace_chat', 'atlas_briefing', 'company_research', 'competitor_research', 'feed_refresh', 'gap_engine', 'dossier_refresh', 'summary_update', 'onboarding_extract', 'grounding_suggest', 'skill_run', 'staleness_sweep'];
