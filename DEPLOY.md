...
| `EXA_API_KEY` *(optional)* | exa.ai — primary leg of the `web_search` provider chain (semantic search + full page text); falls back to Firecrawl search, then the xAI Agent Tools API, when unset |
